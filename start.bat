...
start "KRX Backend (Do Not Close)" cmd /k ".\.venv\Scripts\python.exe -m uvicorn backend.main:app --reload --host 0.0.0.0 --port 8000"
...
echo - Gate API: http://localhost:8000/api/execution_gate
echo.
