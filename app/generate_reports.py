...
def main():
    ...
    integrity = summary.get(
        "integrity",
        {"critical_days": 0, "warning_days": 0, "info_days": 0, "top_codes": []},
    )
    kpis = summary.get(
        "kpis",
        {"gate_open": 0, "executed": 0, "chop_block": 0, "bear_block": 0, "no_data": 0},
    )
    ...
    human_report = {
        ...
        "integrity_summary": {
            ...
            "top_codes": [
                {"code": x.get("code", "UNKNOWN"), "count": x.get("days", 0)}
        ...
        "kpis": [
            {
                "key": "gate_open_days",
                "label_ko": "시장 개장",
                "value": kpis.get("gate_open", 0),
                "unit": "days",
            },
            {
                "key": "executed_days",
                "label_ko": "체결 발생",
                "value": kpis.get("executed", 0),
                "unit": "days",
            },
            {
                "key": "chop_blocked_days",
                "label_ko": "횡보장 방어",
                "value": kpis.get("chop_block", 0),
                "unit": "days",
            },
            {
                "key": "bear_blocked_days",
                "label_ko": "하락장 방어",
                "value": kpis.get("bear_block", 0),
                "unit": "days",
            },
            {
                "key": "no_data_days",
                "label_ko": "데이터 누락",
                "value": kpis.get("no_data", 0),
                "unit": "days",
            },
        ],
        "pointers": {
    ...
    ai_report = {
        ...
        "integrity_flags": {
            "critical_total": integrity.get("critical_days", 0),
            "critical_codes": [
                i.get("code", "UNKNOWN") for i in integrity.get("top_codes", [])[:5]
            ],
        },
        "status": status_badge,
    }
