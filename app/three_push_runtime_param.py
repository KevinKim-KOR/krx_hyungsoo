...
# DB IO (read_active_param_from_db / create_param_version_in_db / activate_param_version)
# 는 Refactor v1 에서 app.runtime_param_store 로 이동. 본 모듈은 schema / validator /
# legacy JSON 만 담당. Cutover v1 § 9 fail-closed 계약은 runtime_param_store 에서 유지.
