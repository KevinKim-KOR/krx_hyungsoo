...
from pc_cockpit.views.helpers.allocation_panel import (
    render_allocation_caption,
    render_allocation_compare_expander,
    render_allocation_trace_expander,
)
            ...
            if not BT_RESULT_PATH.exists():
                ...
                if not bt_data:
                    ...
                    if bt_meta.get("dynamic_execution"):
                        ...
                        # P207: allocation 상세 표시 (R6: helper 로 추출)
                        render_allocation_caption(bt_meta)
                        ...
                        # P207-7C: allocation 비교표 (R6: helper)
                        render_allocation_compare_expander(BASE_DIR)

                        # P208-STEP8A: holding structure 비교표 + 요약 (R6: helpers)
                        ...
                        # P207-7C: 마지막 리밸런스 trace (R6: helper)
