...
최종 업데이트: 2026-08-19 (**구성종목 수집 깊이 30 + 등락률 열 제거** — 설계 확정 구현 · 검증자 **r1·r2 `REJECTED` → r3 재작업 완료, 재검증 대기**)
...
**다음**: 재검증 후 남은 표 카드 전환 — `AISessionsListTab`(8) · `EvidenceDetails`(8) ·
`ConstituentsTab` 구성종목 표(6).
