...
- `docs/handoff/POC2/POC2_MARKET_FLOW_ML_V2_DATA_VALIDITY_MODEL_COMPARISON_CONCLUSION.md` (본 문서)
...
- `docs/handoff/POC2/POC2_FEATURE_INVENTORY.md` (2.41 신규 entry)
- `docs/handoff/POC2/POC2_MARKET_FIRST_OPERATING_DIRECTION.md`
