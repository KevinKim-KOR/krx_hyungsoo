...
| 기능 | 참조 문서 |
|---|---|
| 시장 시계열 SQLite Closeout | `docs/handoff/POC2/POC2_MARKET_TIMESERIES_SQLITE_CLOSEOUT_CONCLUSION.md` |
| Market Risk Reference v1 (KODEX200 + VIX) | `docs/handoff/POC2/POC2_MARKET_RISK_REFERENCE_V1_CONCLUSION.md` |
| Decision Draft Preview v1 | `docs/handoff/POC2/POC2_DECISION_DRAFT_PREVIEW_V1_CONCLUSION.md` |
