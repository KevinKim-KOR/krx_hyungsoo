...
4. docs/handoff/POC2/POC2_STEP7_SYSTEM_OUTPUT_3_PUSH_REALIGNMENT_DESIGN.md — Step7 마스터 설계서
5. docs/handoff/POC2/POC2_STEP7A_NEW_ETF_WATCH_CANDIDATE_MINIMAL_PUSH.md — PUSH 2
6. docs/handoff/POC2/POC2_STEP7B_HOLDINGS_STATUS_BRIEFING_MINIMAL_PUSH.md — PUSH 1
7. docs/handoff/POC2/POC2_STEP7C_FALLING_ETF_CAUTION_SIGNAL_MINIMAL_PUSH.md — PUSH 3
8. 본 문서
...
1. **기반 문서 5개 + 본 문서 정독** (CLAUDE.md §1 절차):
   ...
   - `docs/ASSUMPTIONS.md`
   - `CLAUDE.md`
   - `docs/handoff/POC2/POC2_STEP7_SYSTEM_OUTPUT_3_PUSH_REALIGNMENT_DESIGN.md` (마스터 설계)
