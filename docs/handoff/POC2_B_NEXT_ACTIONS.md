...
**직전 활성 Step (PARTIAL 2026-07-13, PC DONE · OCI 실행 대기)**: **Holdings Evidence OCI Publication v1**. prepare/verify/activate CLI (SSH/SCP 미수행) · TOCTOU 재검증 · mode 600 + owner · 15 focused test. PC source hash `767815e059ad3613...`, size 6238, holding_count 35. 상세는 §0 참조.
