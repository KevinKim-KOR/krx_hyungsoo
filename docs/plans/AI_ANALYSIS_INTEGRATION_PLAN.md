...
### Phase 1: 데이터 내보내기 ✅ 완료 (2025-12-08)
- [x] 백테스트 결과 마크다운 프롬프트 생성 (`promptGenerator.ts`)
- [x] UI에 "AI 분석" 버튼 추가 (튜닝 결과)
- [x] 마크다운 템플릿 자동 생성 (테이블 형식)
- [x] 손실 구간 분석 프롬프트 템플릿
- [x] 새 변수 제안 프롬프트 템플릿
...
### Phase 3: 변수 관리 시스템 (→ 별도 문서)
- 📄 `docs/plans/VARIABLE_SYSTEM_PLAN.md` 참조
- [ ] 새 변수 정의 인터페이스
- [ ] 변수 계산 로직 플러그인 시스템
- [ ] 변수 효과 A/B 테스트 기능
