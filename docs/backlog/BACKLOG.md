...
# POC2 Step 3 (First Factor Signal Integration) 시 추가된 DEFERRED

## DEFERRED: 잘 올라가는 섹터 발굴 Factor
...
## DEFERRED: draft_payload.factor_signals 외 다른 메타 키 추가
