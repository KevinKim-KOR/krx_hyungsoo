...
## Run Context
- **Run ID**: `gate2_20251228_112933_2dc5bd`
- **Mode**: `None`
- **Git**: `None`
...
| multi_lookback | ✅ PASS | Dates: 12M(2022-06-23 00:00:00) <= 6M(2022-12-23 00:00:00) <= 3M(2023-03-23 00:00:00) |
| walkforward_presence | ✅ PASS | Results Found |
| walkforward_validity | ✅ PASS | Windows:3, ZeroTradeWins:0, GlobalTrades:496 |
...
| 3. Executed Trades | 496 | 실제 체결 횟수 |
